...
/*
        ...
        cout<<"Masukkan Z: ";
        cin>>z;*/
        x=-5.4;//-0*sin(sudutNgurang*3.14/180);// tinggi kaki kanan
        y=0;// miring kaki
        z=-2;//+0*sin(sudutNgurang*3.14/180); ;// langkah kaki

        sudutX=0;//miring badan
        sudutY=4;//-2*sin(sudutNgurang*3.14/180);;//kebungkukan badan //14
        sudutZ=0;//putaran badan

        x2=-5.4;//-2*sin(sudutNgurang*3.14/180); //tinggi kaki kiri
        y2=0;
        z2=-2;//+0.5*sin(sudutNgurang*3.14/180);

        sudutX2=0;
        sudutY2=4;//-2*sin(sudutNgurang*3.14/180);;
        sudutZ2=0;
        ...
        //inverseAndre(sudutX,sudutY,sudutZ,x,y,z,sudutX2,sudutY2,sudutZ2,x2,y2,z2,speed,'2');
         inverseAndre(sudutX,sudutY,sudutZ,x,y,z,sudutX2,sudutY2,sudutZ2,x2,y2,z2,speed,512,512,'2',700,500,250,780,500,500,data_image.x_head,data_image.y_head);
//      usleep(1000);
//         cout<<"Masukkan sudut X: "<<f2<<endl;
	...
	sudutNgurang=f2;
        x=-8.4-2*sin(sudutNgurang*3.14/180);  							//-13.4+0*sin(sudutNgurang*3.14/180); 
        ...
        sudutY=12+4*sin(sudutNgurang*3.14/360); 		//8-1				//14
        sudutZ=0;//-0.5+0.5*cos(sudutNgurang*3.14/180);//1*sin(sudutNgurang*3.14/180)*1.4;;//3*(pow(sin(sudutNgurang*3.14/180),2));  	//0

        x2=-8.4-2*sin(sudutNgurang*3.14/180); 							//-13.4+1*sin(sudutNgurang*3.14/180);
        ...
        sudutY2=12+4*sin(sudutNgurang*3.14/360);								//14
    	sudutZ2=0;//-1+1*cos(sudutNgurang*3.14/180);//-3*(pow(sin(sudutNgurang*3.14/180),2))			//0
        speed=75;//+50*cos(sudutNgurang*3.14/360);
...
//       cout<<"Masukkan sudut X: ";
	...
	cout<<"stack\n";							        // MIRING KIRI//
     //   for(int j=0;j<=76;j++){
        ...
        {f2=f2+0.008;
        sudutNgurang=f2;
        x=-11.4-2*sin(sudutNgurang*3.14/180);						//13.4
        y=0;												//-1*sin(sudutNgurang*3.14/180);
        z=0;												//-1

        sudutX=0;			/*(pow(sin(sudutNgurang*3.14/180),2));*/			//2*sin(sudutNgurang*3.14/180);
 	sudutY=14+1*sin(sudutNgurang*3.14/180);					//5-2						//14
        sudutZ=0;//2;//3*(pow(sin(sudutNgurang*3.14/180),2));						//0

        x2=-11.4-2*sin(sudutNgurang*3.14/180);							//-13.4
        y2=0;												//-1*sin(sudutNgurang*3.14/180);
        z2=0;												//1

        sudutX2=0;/*(pow(sin(sudutNgurang*3.14/180),2));*/			//2*sin(sudutNgurang*3.14/180);
        sudutY2=14+1*sin(sudutNgurang*3.14/180);							//14
        sudutZ2=0;//-2;//-3*(pow(sin(sudutNgurang*3.14/180),2));					//0
