...
//         cout<<"Masukkan sudut X: "<<f2<<endl;
	...
	sudutNgurang=f2;
        x=tempx+2*sin(sudutNgurang*3.14/180); //+2	//
        ...
        sudutX=temp_sudutX-10*sin(sudutNgurang*3.14/180);//(pow(sin(sudutNgurang*3.14/180),2));//sebelum -4
        ...
        y2=tempy2;//+2*sin(sudutNgurang*3.14/180);// + pidy;//sin(sudutNgurang*3.14/180);//2.5+2	// -1
        z2=tempz2-0.5*sin(sudutNgurang*3.14/360);//-0.5 //+0.5 //  2*sin(360)

        sudutX2=temp_sudutX2-0*sin(sudutNgurang*3.14/180);// - pidx;(pow(sin(sudutNgurang*3.14/180),2));		//-20 BENER
...
//       cout<<"Masukkan sudut X: ";
	...
	//sleep(1);//2
        ...
        y=tempy-2*sin(sudutNgurang*3.14/180);//0.5 sebelum
        z=tempz;//0.5;//cos(sudutNgurang*3.14/180);

        sudutX=temp_sudutX;//+1*sin(sudutNgurang*3.14/180);//(pow(sin(sudutNgurang*3.14/180),2));   	-0.5
 	sudutY=temp_sudutY+2*sin(sudutNgurang*3.14/180);
        ...
        y2=tempy2-6*sin(sudutNgurang*3.14/180);
        z2=tempz2;//0.2;//cos(sudutNgurang*3.14/180);

        sudutX2=temp_sudutX2;//+1*sin(sudutNgurang*3.14/180);//(pow(sin(sudutNgurang*3.14/180),2));
...
//      inverseAndre(sudutX,sudutY,sudutZ,x,y,z,sudutX2,sudutY2,sudutZ2,x2,y2,z2,speed,'2');
        ...
        temp_sudutY=sudutY;//2+sudutY+8*sin(2*sudutNgurang*3.14/180);//+0*sin(sudutNgurang*3.14/180);//+sin(sudutNgurang*3.14/180);
        temp_sudutZ=sudutZ;//-0.5-0.5*cos(sudutNgurang*3.14/180);//3*(pow(sin(sudutNgurang*3.14/180),2));

        tempx2=x2+2*sin(sudutNgurang*3.14/180);
        tempy2=y2-0*sin(sudutNgurang*3.14/180);// -1
        tempz2=z2+1*sin(sudutNgurang*3.14/360); 			//-1
 	//z2=-1*cos(sudutNgurang*3.14/180);
        ...
        temp_sudutY2=sudutY;//2+sudutY2+8*sin(2*sudutNgurang*3.14/180);//+2*sin(2*sudutNgurang*3.14/360);
...
//      inverseAndre(sudutX,sudutY,sudutZ,x,y,z,sudutX2,sudutY2,sudutZ2,x2,y2,z2,speed,'2');
	...
	cout<<x2<<endl<<y2<<endl<<z2<<endl<<sudutX2<<endl<<sudutY2<<endl<<sudutZ2<<endl;
                ...
                //usleep(500000);
        usleep(500);//usleep(300000); //usleep(300000)
/*							        // MIRING KANAN //
while(f2<=90)
