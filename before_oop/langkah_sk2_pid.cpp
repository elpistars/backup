...
a        cin>>x;
        ...
        sudutY=25;//kebungkukan badan
        sudutZ=0;//putaran badan

        x2=-10; //tinggi kaki kiri
        y2=0;
        z2=0;
...
//sleep(1000);
	...
	while(f2<=90.0)
        ...
        temp_sudutX=sudutX-9*sin(sudutNgurang*3.14/180);//(pow(sin(sudutNgurang*3.14/180),2));
        ...
        tempy2=y2-4*sin(sudutNgurang*3.14/180);//-1.5
        tempz2=z2;
        ...
        //inverseAndre(sudutX,sudutY,sudutZ,x,y,z,sudutX2,sudutY2,sudutZ2,x2,y2,z2,speed,'2');
         inverseAndre(temp_sudutX,temp_sudutY,0,tempx,tempy,tempz,temp_sudutX2,temp_sudutY2,0,tempx2,tempy2,tempz2,speed,552,512,'2',480,520,270,750,250,750,data_image.x_head,data_image.y_head);
//      usleep(1000);
