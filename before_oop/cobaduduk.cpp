...
//      inverseAndre(sudutX,sudutY,sudutZ,x,y,z,sudutX2,sudutY2,sudutZ2,x2,y2,z2,speed,'2');
        ...
        f2=f2+0.08;
        sudutNgurang=f2;
        tempx=x+5*sin(sudutNgurang*3.14/180); // sebelum 2
        tempy=y+5*sin(sudutNgurang*3.14/180);//1+1*sin(sudutNgurang*3.14/180);//- pidy;//2.4    //sebelum +1
        tempz=z+2*sin(sudutNgurang*3.14/360); //sebelum 2
