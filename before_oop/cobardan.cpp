...
/*
        ...
        cout<<"Masukkan Z: ";
        cin>>z;*/
        x=-10.6;// tinggi kaki kanan //-13.4
        y=0;// miring kaki			//-0.3
        z=0;// langkah kaki 			//0

        sudutX=0;//miring badan			//3
...
void jalan(){
	 double x,y,z,sudutX,sudutY,sudutZ,x2,y2,z2,sudutX2,sudutY2,sudutZ2,sudutNgurang;
        ...
        x=-10.6;//-2*sin(sudutNgurang*3.14/180)*2;
        y=0-2*sin(sudutNgurang*3.14/180);			//-0.3
        z=0; //2.5

        sudutX=0+2*sin(sudutNgurang*3.14/180);/*(pow(sin(sudutNgurang*3.14/180),2));*/
        sudutY=20;//+sin(sudutNgurang*3.14/180);
        sudutZ=0;//3*(pow(sin(sudutNgurang*3.14/180),2));

        x2=-10.4;//+sin(sudutNgurang*3.14/180)*2;
        y2=0-2*sin(sudutNgurang*3.14/180);//-1.5
        z2=0;

        sudutX2=0+2*sin(sudutNgurang*3.14/180);/*(pow(sin(sudutNgurang*3.14/180),2));*/
        sudutY2=20;//-sin(sudutNgurang*3.14/180);
...
//         cout<<"Masukkan sudut X: "<<f2<<endl;
	...
	sudutNgurang=f2;
        x=-10.6+0*sin(sudutNgurang*3.14/180); //+2
        y=0-2-0.7*sin(sudutNgurang*3.14/180);//cos(sudutNgurang*3.14/360);//1.5
        z=-0.75+0.75*cos(sudutNgurang*3.14/180); //0+0.5-0.5*cos(sudutNgurang*3.14/180);1

        sudutX=0-2*sin(sudutNgurang*3.14/180);//*(pow(sin(sudutNgurang*3.14/180),2));*//0
        sudutY=20;//-2*sin(sudutNgurang*3.14/360); /-3
        sudutZ=0;//-0.5+0.5*cos(sudutNgurang*3.14/180);//1*sin(sudutNgurang*3.14/180)*1.4;;//3*(pow(sin(sudutNgurang*3.14/180),2));

        x2=-10.4+2*sin(sudutNgurang*3.14/180); //-11.4-0
        y2=0-2-2*sin(sudutNgurang*3.14/180);// + pidy;//sin(sudutNgurang*3.14/180);//2.5+2
        z2=0.75-0.75*cos(sudutNgurang*3.14/180);//-0.5 //+0.5

        sudutX2=0+2+6*sin(sudutNgurang*3.14/180);// - pidx;/*(pow(sin(sudutNgurang*3.14/180),2));*/-2 //9+16
        sudutY2=20;//-2*cos(sudutNgurang*3.14/360);//-3
...
//              if(i>46){
 	...
 	//for(int i=0;i<=38;i++)
        ...
        {f2=f2+0.006;
         sudutNgurang=f2;
        x=-10.6;//-sin(sudutNgurang*3.14/180)*2;
        y=0+1-1*sin(sudutNgurang*3.14/180);//2.4
        z=0;//-1.5;

        sudutX=0-2-2*sin(sudutNgurang*3.14/180);/*(pow(sin(sudutNgurang*3.14/180),2));*/
        sudutY=20;//+2*sin(sudutNgurang*3.14/180);
        sudutZ=0;//-2;//2;//3*(pow(sin(sudutNgurang*3.14/180),2));

        x2=-10.4;//+sin(sudutNgurang*3.14/180)*2;
        y2=0+1-1*sin(sudutNgurang*3.14/180);//2.4
        z2=0;//1.5;//0.2;//.2;

        sudutX2=0+2-2*sin(sudutNgurang*3.14/180);/*(pow(sin(sudutNgurang*3.14/180),2));*/
        sudutY2=20;//+2*sin(sudutNgurang*3.14/180);
...
//      inverseAndre(sudutX,sudutY,sudutZ,x,y,z,sudutX2,sudutY2,sudutZ2,x2,y2,z2,speed,'2');
	...
	jdt=0.3;
        ...
        f2=f2+0.009;
        sudutNgurang=f2;
        x=-10.6+2*sin(sudutNgurang*3.14/180);
        y=-0.3-1+2*sin(sudutNgurang*3.14/180);//1+1*sin(sudutNgurang*3.14/180);//- pidy;//2.4
        z=0.5*sin(sudutNgurang*3.14/360);

        sudutX=3-2;//+10*sin(sudutNgurang*3.14/180);//- pidx;/*(pow(sin(sudutNgurang*3.14/180),2));*/
        sudutY=-6;//sin(2*sudutNgurang*3.14/360);//+sin(sudutNgurang*3.14/180);
        ...
        z2=0;//-0.5*sin(sudutNgurang*3.14/360);
 	//z2=-1*cos(sudutNgurang*3.14/180);

        sudutX2=2.5-2+12*sin(sudutNgurang*3.14/180);//sin(sudutNgurang*3.14/180);/*(pow(sin(sudutNgurang*3.14/180),2));*/
        sudutY2=-6;//+2*sin(2*sudutNgurang*3.14/360);
...
//		usleep(500);    
        ...
        f2=f2+a;
        sudutNgurang=f2;
        x=-10.6;//+sin(sudutNgurang*3.14/180)*1.4;
