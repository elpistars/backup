...
inline void inverseAndre( double sudutX, double sudutY, double sudutZ, double x, double y, double z, double sudutX2, double sudutY2, double sudutZ2,double x2, double y2,double z2, int speed,int no7, int no8, char gerakan,int tk1,int tk2,int tk3,int tk4,int tk5,int tk6, int x_head, int y_head){
...
//	 nilaiPaha2 = 512 + ((sudutPaha2*180/3.14)/0.29);
	...
	*/
	...
	int n=totalServo;
	int tq=1023;
	/*cout<<"9: "<<(int)nilaiPantat<<endl<<"10: "<<(int) nilaiPantat2<<endl;
	cout<<"11: "<<(int)nilaiPaha<<endl<<"12: "<<(int) nilaiPaha2<<endl;
	cout<<"13: "<<(int)nilaiLutut<<endl<<"14: "<<(int) nilaiLutut2<<endl;*/
