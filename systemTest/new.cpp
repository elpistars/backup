...
//	usleep(1000);	
 ...
 cout<<"Masukkan sudut X: ";
	...
	{f2=f2+a;
	 ...
	 sudutNgurang=f2;
	x=-13.4+3*sin(sudutNgurang*3.14/180);
	...
	sudutY=-3;//-2*sin(sudutNgurang*3.14/360);
        ...
        sudutY2=-3;//-2*cos(sudutNgurang*3.14/360);
...
//	 cout<<"Masukkan sudut X: ";
	...
	{f2=f2+a;
	 sudutNgurang=f2;
        ...
        y2=1*sin(sudutNgurang*3.14/180);//2.4
        z2=-1.6;//0.2;//cos(sudutNgurang*3.14/180);
        sudutX2=2*sin(sudutNgurang*3.14/180);/*(pow(sin(sudutNgurang*3.14/180),2));*/
...
//	 inverseAndre(sudutX,sudutY,sudutZ,x,y,z,sudutX2,sudutY2,sudutZ2,x2,y2,z2,speed,'2');      
	...
	// speed=200*cos(sudutNgurang*3.14*0.5/180);
        ...
        sudutX2=2+12*sin(sudutNgurang*3.14/180);//sin(sudutNgurang*3.14/180);/*(pow(sin(sudutNgurang*3.14/180),2));*/
...
//	inverseAndre(sudutX,sudutY,sudutZ,x,y,z,sudutX2,sudutY2,sudutZ2,x2,y2,z2,speed,'2');
   ...
   usleep(5000);
	...
	x=-13.4+2*sin(sudutNgurang*3.14/180);
        ...
        sudutY=-3+0*sin(sudutNgurang*3.14/180);
        sudutZ=0;//cos(sudutNgurang*3.14/180);//3*(pow(sin(sudutNgurang*3.14/180),2));
        x2=-13.4;//+sin(sudutNgurang*3.14/180)*1.5;
        ...
        sudutY2=-3+0*sin(sudutNgurang*3.14/180);//-sin(sudutNgurang*3.14/180);
        sudutZ2=0;//-1+1*cos(sudutNgurang*3.14/180);//-3*(pow(sin(sudutNgurang*3.14/180),2));
