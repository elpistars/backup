...
//====================
	 ...
	 sudutNgurang=2.4*i;
	x=-14+3*sin(sudutNgurang*3.14/180)*1.4;
	...
	sudutY=10+0*cos(sudutNgurang*3.14/180)+pidy2;
        ...
        sudutY2=10;//+5*sin(sudutNgurang*3.14/360)+pidy2;
...
//==================	
	...
	y=-2-0*sin(sudutNgurang*3.14/180)- pidy;//2.4
        z=1*cos(sudutNgurang*3.14/360);
	...
	// speed=200*cos(sudutNgurang*3.14*0.5/180);
        ...
        x2=-14+3*sin(sudutNgurang*3.14/180);
        y2=-2-0*sin(sudutNgurang*3.14/180);//2.4
        z2=-1*cos(sudutNgurang*3.14/180);
        sudutX2=-3-18*sin(sudutNgurang*3.14/180);//sin(sudutNgurang*3.14/180);/*(pow(sin(sudutNgurang*3.14/180),2));*/
        sudutY2=10+0*sin(sudutNgurang*3.14/180)+pidy2;
        sudutZ2=0;//-1-1*cos(sudutNgurang*3.14/180);//-3*(pow(sin(sudutNgurang*3.14/180),2));
  	 speed=100;//cos(sudutNgurang*3.14/360);
	 //===============
...
//    edkasblm = 0;
	...
	//=======================
        ...
        y2=2+0*sin(sudutNgurang*3.14/180)+pidy;//2.4
        z2=1*cos(sudutNgurang*3.14/180);
        sudutX2=2-8*sin(sudutNgurang*3.14/180)- pidx;//sin(sudutNgurang*3.14/180);/*(pow(sin(sudutNgurang*3.14/180),2));*/
        sudutY2=10+0*sin(sudutNgurang*3.14/180)+pidy2;//-sin(sudutNgurang*3.14/180);
        sudutZ2=0;//-1+1*cos(sudutNgurang*3.14/180);//-3*(pow(sin(sudutNgurang*3.14/180),2));
        speed=100;//*cos(sudutNgurang*3.14/360);
		//==================
		sensen();
