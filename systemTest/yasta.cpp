...
double kpx = 1.25;//.025; //pid kanan kiri
double kdx = 4.23;//.4;	//pid kanan kiri
double kpy = 10.25;//.014;	//pid kanan kiri
double kdy = 0.4;//.23;//.0068;	//pid kanan kiri
...
/*        cout<<"Masukkan sudut X: ";
	...
	tki = 744;
	//===============
	 inverseAndre(sudutX,sudutY,sudutZ,x,y,z,sudutX2,sudutY2,sudutZ2,x2,y2,z2,50,200,200,'2');
	cout<<"Masukkan Speed: ";
	geraktangan();
	//cin>>speed;
	/*cout<<"tkan : "<<tkan<<endl;
