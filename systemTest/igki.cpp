...
//	cout << "Masukkan sudut X: ";
	...
	while(f2<=180)
	{
		...
		x=-11.4+0*sin(sudutNgurang*3.14/180);
        	y=1+2*sin(sudutNgurang*3.14/180);//cos(sudutNgurang*3.14/360);//2.4
		...
		sudutY=0;//+6*sin(sudutNgurang*3.14/360);
	        ...
	        x2=-11.4+3*sin(sudutNgurang*3.14/180);
		...
		sudutZ2=512-30*cos(sudutNgurang*3.14/360);//-3*(pow(sin(sudutNgurang*3.14/180),2));
...
// --------------------------- BALIKIN MIRING //
	...
	while(f2<=90)
	{
		...
		sudutNgurang=f2;
	        ...
	        sudutZ2=482;//-2;//-3*(pow(sin(sudutNgurang*3.14/180),2 
...
// ------------------------ ANGKAT KAKI DAN MENDARAT/
		...
		while(f2<=180){
			...
			z=0.4-0.4*cos(sudutNgurang*3.14/180);
			...
			sudutZ=512;//-30*sin(sudutNgurang*3.14/360);//3*(pow(sin(sudutNgurang*3.14/180),2));
			x2=-11.4+0*sin(sudutNgurang*3.14/180);
			y2=-1-2*sin(sudutNgurang*3.14/180);//2.4
			...
			sudutZ2=482+30*sin(sudutNgurang*3.14/360);//-3*(pow(sin(sudutNgurang*3.14/180),2));
		...
		while(f2<=90){
			...
			sudutY=0;//-4+4*sin(sudutNgurang*3.14/180);
