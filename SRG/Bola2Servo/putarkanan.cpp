...
// ------------------  ANKAT KAKI DAN MENDARAT //
	while(f2<=180)
	{
		...
		sudutY=-5;//+6*sin(sudutNgurang*3.14/360);
	        ...
	        sudutX2=-2+26*sin(sudutNgurang*3.14/180);// - pidx;/*(pow(sin(sudutNgurang*3.14/180),2));*/
...
// ------------------------ ANGKAT KAKI DAN MENDARAT/
		...
		while(f2<=180){
			...
			x2=-10.4+1*sin(sudutNgurang*3.14/180);
			...
			sudutZ2=472+40*sin(sudutNgurang*3.14/360);//-3*(pow(sin(sudutNgurang*3.14/180),2));
