...
/*        cout<<"Masukkan sudut X: ";
	...
	// MIRING //
	 ...
	 sudutNgurang=2.4*i;
        x=-10;//-sin(sudutNgurang*3.14/180)*2;
        y=-1.3*sin(sudutNgurang*3.14/180);//2.4
        z=0;
	...
	inverseAndre(sudutX,sudutY,sudutZ,x,y,z,sudutX2,sudutY2,sudutZ2,x2,y2,z2,100,'1');
//	sleep(1);
	}
	...
	x=-10-sin(sudutNgurang*3.14/180)*1.4;
        y=-1.3;//cos(sudutNgurang*3.14/360);//2.4
        z2=0.6-0.6*cos(sudutNgurang*3.14/180);
	sudutX=1.5-8*sin(sudutNgurang*3.14/180);/*(pow(sin(sudutNgurang*3.14/180),2));*/	
	sudutY=8;//+sin(sudutNgurang*3.14/180);
        sudutZ2=0.5-0.5*cos(sudutNgurang*3.14/180);//1*sin(sudutNgurang*3.14/180)*1.4;;//3*(pow(sin(sudutNgurang*3.14/180),2));
        x2=-10+sin(sudutNgurang*3.14/180)*1.7;
      	y2=-1.3;//sin(sudutNgurang*3.14/180);//2.4
      	z=0;//0.1-0.1*cos(sudutNgurang*3.14/180);
        sudutX2=1;//8*sin(sudutNgurang*3.14/180);/*(pow(sin(sudutNgurang*3.14/180),2));*/
        sudutY2=8+1*sin(sudutNgurang*3.14/180);
        sudutZ=1-1*cos(sudutNgurang*3.14/180);//-3*(pow(sin(sudutNgurang*3.14/180),2));
  	inverseAndre(sudutX,sudutY,sudutZ,x,y,z,sudutX2,sudutY2,sudutZ2,x2,y2,z2,100,'1');
		}
	usleep(100);
	// BALIKIN MIRING //
	 ...
	 sudutNgurang=2.4*i;
        x=-10;//-sin(sudutNgurang*3.14/180)*2;
        y=-1.3+1.3*sin(sudutNgurang*3.14/180);//2.4
        z2=1.2;
        sudutX=1.5-1.5*sin(sudutNgurang*3.14/180);/*(pow(sin(sudutNgurang*3.14/180),2));*/
        sudutY=8;//+sin(sudutNgurang*3.14/180);
        sudutZ2=1;//-2;//2;//3*(pow(sin(sudutNgurang*3.14/180),2));
        x2=-10;//+sin(sudutNgurang*3.14/180)*2;
        y2=-1.3+1.3*sin(sudutNgurang*3.14/180);//2.4
        z=0;//0.2;//.2;
        sudutX2=1.5-1.5*sin(sudutNgurang*3.14/180);/*(pow(sin(sudutNgurang*3.14/180),2));*/
        sudutY2=8;//-sin(sudutNgurang*3.14/180);
        sudutZ=2;//-2;//-3*(pow(sin(sudutNgurang*3.14/180),2 
	inverseAndre(sudutX,sudutY,sudutZ,x,y,z,sudutX2,sudutY2,sudutZ2,x2,y2,z2,100,'1');     
 }
	usleep(100);
	// MIRING //	
for(int j=0;j<=7;j++){
	...
	for(int i=0;i<=38;i++){
	 sudutNgurang=2.4*i;
        ...
        sudutX=-1.5*sin(sudutNgurang*3.14/180);/*(pow(sin(sudutNgurang*3.14/180),2));*/
        sudutY=8;//+sin(sudutNgurang*3.14/180);
        sudutZ2=1;//2;//3*(pow(sin(sudutNgurang*3.14/180),2));
        x2=-10;//-sin(sudutNgurang*3.14/180)*2.4;
        y2=1.3*sin(sudutNgurang*3.14/180);//2.4
        z=0;//0.2;//cos(sudutNgurang*3.14/180);
        sudutX2=-1.5*sin(sudutNgurang*3.14/180);/*(pow(sin(sudutNgurang*3.14/180),2));*/
        sudutY2=8;//-sin(sudutNgurang*3.14/180);
        sudutZ=2;//-2;//-3*(pow(sin(sudutNgurang*3.14/180),2));
        inverseAndre(sudutX,sudutY,sudutZ,x,y,z,sudutX2,sudutY2,sudutZ2,x2,y2,z2,100,'1');      
	...
	for(int i=0;i<=76;i++){
 	 sudutNgurang=2.4*i;
        ...
        sudutZ2=0.5+0.5*cos(sudutNgurang*3.14/180);//3*(pow(sin(sudutNgurang*3.14/180),2));
   ...
   usleep(100);
        ...
        sudutX=1.5-1.5*sin(sudutNgurang*3.14/180);
        sudutY2=8;//-sin(sudutNgurang*3.14/180);
        sudutZ=2;//-3*(pow(sin(sudutNgurang*3.14/180),2));
        inverseAndre(sudutX,sudutY,sudutZ,x,y,z,sudutX2,sudutY2,sudutZ2,x2,y2,z2,100,'1');
